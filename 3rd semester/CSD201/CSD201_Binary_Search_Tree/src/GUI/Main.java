...
import Function.MyBinarySreachTree;
import btp.*;
...
//        bst.addTree(randomTree, "random");
        ...
        System.out.print(bst.search(bst.root, info));
        System.out.println("\n==================================================");
        
        System.out.println("Search father of node have value = " + info + ":");
        System.out.print(bst.searchFatherOf(bst.search(bst.root, info)));
        System.out.println("\n==================================================");
        ...
        bst.deletionByCopying(bst.search(bst.root, info));
        bst.breadthFirstSearch(bst.root);
        System.out.println("\n==================================================");
        
        info = 8;
        System.out.println("Delete node (using Merging) has value = " + info);
        bst.deletionByMerging(bst.search(bst.root, info));
        bst.breadthFirstSearch(bst.root);
        System.out.println("\n==================================================");
        
        System.out.println("Graphical representation of tree: ");
        BTPrinter.printTree(1,2,3,4,5,6,7,8);
