...
public class ValidationInput {
    ...
    public static Customer inputCustomerData(){
        System.out.println("Add new customer data:");
        String customerCode = inputString("Input Customer code: ");
        String sustomerName = inputString("Input Customer name: ");
        String phone = inputString("Input Customer phone: ");
        System.out.println("");
        Customer newCustomer = null;
        try {
            newCustomer = new Customer(customerCode, sustomerName, phone);
