...
public class ProductMenu {
    ...
    public static void loadDataFromFile() {
        ...
        // /*Auto add data*/ String filePath = "D:\\Specialized - SE1731\\Ki3_Spring 2023\\CSD201\\JavaCode\\CSD201_Sale_Management_System\\src\\Data\\ProductData_SaleManagementSystem.txt";
...
To split the string on a pipe character, need to escape it with a backslash (\\|) to indicate that it should be treated as a literal character rather than a regular expression metacharacter.
    ...
    public static void searchByProductCode() {
        ...
        try {
            tempProduct = (Product) productList.search(ValidationInput.inputString("Input product code need to search: ")).getData();
            System.out.println("\nFound " + tempProduct + "!");
    ...
    public static void delNodeAfterxCode() {
        ...
        productList.deleteAfter(productList.search(ValidationInput.inputString("Input code of node want to delete its after node: ")));
    }
